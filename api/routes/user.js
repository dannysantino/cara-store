...
router.put('/:id', verifyTokenAndAuth, catchAsync(async (req, res) => {
...
router.get('/', verifyTokenAndAdmin, catchAsync(async (req, res) => {
...
router.get('/stats', verifyTokenAndAdmin, catchAsync(async (req, res) => {
    const date = new Date();
